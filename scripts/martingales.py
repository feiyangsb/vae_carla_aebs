...
@create date 2020-02-23 13:11:59
@modify date 2020-02-23 13:11:59
@desc Three martingales are implemented.
"""
    ...
    def __call__(self, p):
        ...
        if self.sliding_window_size:
            if len(self.extended_p_list) >= 3*self.sliding_window_size:
                self.extended_p_list = self.extended_p_list[-3 * self.sliding_window_size:]
        return self.M
